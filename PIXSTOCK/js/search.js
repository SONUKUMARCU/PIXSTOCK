...
addEventOnElement($searchTogglers, "click", () => $searchView.classList.toggle("show"));
...
/**
 * Submit search when user press enter key
 */
...
const updateSearchHistory = searchValue => {
    ...
    /**
     * if the searched value is already in search list then remove that one and add the search value at the beginning of the search list
